...
const TransporterTable = () => {
  ...
  const tableData = [
    { 
      id: '1', 
      transporterId: '24XXXXXXXXXXXXZV', 
      name: 'Barry Tone', 
      vehicleNo: 'GJXX XX XX21', 
      mode: 'Road', 
      vehicleType: 'Regular', 
      status: 'Active',
      hasChildren: false 
    ...
    { 
      id: '2', 
      transporterId: '27XXXXXXXXXXXXZV', 
      name: 'John Smith', 
      vehicleNo: 'MHXX XX XX45', 
      mode: 'Air', 
      vehicleType: 'Express', 
      status: 'Active',
      hasChildren: false 
    ...
    { 
      id: '3', 
      transporterId: '29XXXXXXXXXXXXZV', 
      name: 'Alice Johnson', 
      vehicleNo: 'DLXX XX XX67', 
      mode: 'Sea', 
    ...
    { 
      id: '4', 
      transporterId: '31XXXXXXXXXXXXZV', 
      name: 'Robert Brown', 
      vehicleNo: 'KAXX XX XX89', 
      mode: 'Rail', 
      vehicleType: 'Bulk', 
      status: 'Active',
      hasChildren: false 
  ...
  const columnConfig = {
    All: [
      { key: 'transporterId', label: 'Transporter ID', width: '180px' },
      { key: 'name', label: 'Name', width: '180px' },
      { key: 'vehicleNo', label: 'Vehicle No.', width: '150px' },
      { key: 'mode', label: 'Mode', width: '120px' },
      { key: 'vehicleType', label: 'Vehicle Type', width: '150px' },
      ...
      <div className="card shadow-sm">
        <div className="card-body p-0">
          <div className="d-flex justify-content-between align-items-center p-3 border-bottom bg-light">
            <h5 className="mb-0">Transporters</h5>
            <Button variant="primary" size="sm" onClick={() => navigate('/transporter/new')}>
              <FaPlus className="me-1" /> Create Transporter
            </Button>
          </div>
